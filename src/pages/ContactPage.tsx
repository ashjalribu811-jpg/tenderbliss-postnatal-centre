          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex items-start gap-4 md:gap-6">
              ...
              <div className="flex flex-col pt-4 min-w-0">
                ...
                <a href="mailto:tenderblisswellness@gmail.com" className="text-neutral-800 text-base md:text-lg font-medium hover:text-primary-300 transition-colors break-all">
                  tenderblisswellness@gmail.com
                </a>
              </div>
            </div>
