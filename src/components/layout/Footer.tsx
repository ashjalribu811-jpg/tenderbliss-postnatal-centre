            ...
            <ul className="flex flex-col items-start md:items-start space-y-4 text-base w-fit mx-auto md:mx-0">
              ...
              <li className="flex flex-row items-start justify-start gap-2 text-neutral-500">
                ...
                <div className="flex flex-col items-start gap-1">
                  ...
                  <a href="https://wa.me/918848904949" target="_blank" rel="noopener noreferrer" className="hover:text-primary-300 transition-colors">+91 8848904949</a>
                </div>
              </li>
              <li className="flex flex-row items-center justify-start gap-2 text-neutral-500">
                ...
                <a href="mailto:tenderblisswellness@gmail.com" className="hover:text-primary-300 transition-colors">tenderblisswellness@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
